...
- Runtime environments: local developer machine (macOS/Linux/Windows), Node.js >= 22.19.0 (see `docs/adr/0003-node-floor-raised-to-22-for-promise-withResolvers.md` and `docs/adr/0030-built-in-web-search-and-fetch.md`); browser (Chromium/WebKit/Firefox) for the desktop renderer served by Vite or loaded from Electron's BrowserWindow in Sprint 3+
