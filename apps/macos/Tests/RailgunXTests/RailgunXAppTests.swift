...
final class RailgunXAppTests: XCTestCase {
    ...
    func testNativeReleaseUsesAnExplicitSparkleInfoPlistAndArchitecture() throws {
        ...
        XCTAssertTrue(infoPlist.contains("<key>NSDesktopFolderUsageDescription</key>"))
        XCTAssertTrue(infoPlist.contains("<key>NSDocumentsFolderUsageDescription</key>"))
        XCTAssertTrue(infoPlist.contains("<key>NSDownloadsFolderUsageDescription</key>"))
        XCTAssertTrue(archiveScript.contains("RAILGUNX_SPARKLE_FEED_ARCHITECTURE=\"$architecture\""))
        XCTAssertTrue(archiveScript.contains("CODE_SIGN_STYLE=Manual"))
        XCTAssertTrue(archiveScript.contains("DEVELOPMENT_TEAM=GUKP6SNV36"))
        ...
        XCTAssertTrue(projectValidation.contains("CODE_SIGN_STYLE=Manual"))
        XCTAssertTrue(projectValidation.contains("DEVELOPMENT_TEAM=GUKP6SNV36"))
