...
import { ArrowLeft, Bot, Brain, CircleUserRound, FileText, Search, Server, ShieldCheck, SlidersHorizontal, Sparkles, Stethoscope } from "lucide-react";
...
export const SettingsPage = ({ backend, agentRunning, scenarios, onBack, onDirtyChange, onSaved, onRetryBackend, onSelectScenario }: SettingsPageProps): React.JSX.Element => {
