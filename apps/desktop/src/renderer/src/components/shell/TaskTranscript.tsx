...
function TranscriptLoading(): React.JSX.Element {
  return (
    <div
      ...
      className="mx-auto flex w-full max-w-180 flex-col gap-6 p-4"
      role="status"
    >
